class Resources:
    def __init__(self, energy, common_alloy, rare_alloy, concrete, electronic, military_equipment,
        ...
        self.resources = [[energy, common_alloy, rare_alloy, concrete, electronic, military_equipment],
                          [raw_metal, uranium, limestone, granite, wood, plastic, science_box],
                          [liquid_fossil, solid_fossil, hydrogen],
                          [food, water, consumer_good],
